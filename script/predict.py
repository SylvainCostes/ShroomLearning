...
if __name__ == '__main__':
    ...
    # tout les arguments envoyés par node js (formulaire)
    R = sys.argv[1]
    G = sys.argv[2]
    B = sys.argv[3]
    ...
    # si le modèle prédit 0, le champignon est comestible etc etc
    if prediction[0] == 0:
        print("Edible")
    elif prediction[0] == 1:
        print("Inedible")
        ...
        print("Y'a un problème chef...mauvaise recette?")
